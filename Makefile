...
SOURCES = \
	__init__.py \
	skraafoto.py skraafoto_dialog.py

PLUGINNAME = skraafoto

PY_FILES = \
	__init__.py \
	skraafoto.py skraafoto_dialog.py

UI_FILES = skraafoto_dialog_base.ui
...
QGISDIR=C:\Users\andj\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
